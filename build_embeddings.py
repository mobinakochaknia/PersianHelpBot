...
if __name__ == "__main__":
    ...
    },
    {
        ...
        "answer": "ابتدا از قسمت شروع، سپس دیدگاه من(نرم افزارها)  قسمت مدیریت  فرآیندها کسب و کار >> عملیات >>کارتابل  BPMS میتوان دسترسی پیدا کرد. برای اطلاعات بیشتر می توانید به لینک زیر مشاهده کنید"
    },
    {
